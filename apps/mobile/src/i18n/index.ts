...
const dictionaries: Record<Locale, TranslationTable> = {
  'ja-JP': {
    ...
    'recentLogs.resetNotice': '無料プランでは記録が30日で整理されます。過去90日を見たいときは友だちを招待してプレミアムになりましょう。',
    'recentLogs.addMore': '記録する',
    'recentLogs.viewAll': 'すべて表示',
    'recentLogs.premiumUpsell.title': '過去90日の履歴をチェック',
    'recentLogs.premiumUpsell.description': '友だちを招待してプレミアムにアップグレードすると、記録を90日間保存できます。',
    'recentLogs.premiumUpsell.cta': '紹介プログラムを見る',
    'history.title': '食事履歴',
  ...
  'en-US': {
    ...
    'recentLogs.resetNotice': 'On the free plan, your history is trimmed after 30 days. Invite a friend to unlock 90 days with premium.',
    'recentLogs.addMore': 'Log a meal',
    'recentLogs.viewAll': 'View all',
    'recentLogs.premiumUpsell.title': 'See the last 90 days',
    'recentLogs.premiumUpsell.description': 'Invite a friend to upgrade to premium and keep up to 90 days of meal history.',
    'recentLogs.premiumUpsell.cta': 'Open referral program',
