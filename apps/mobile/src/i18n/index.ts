...
const dictionaries: Record<Locale, TranslationTable> = {
  'ja-JP': {
    ...
    'dashboard.monthlyDeficit.newTitle': '今月のマイナスカロリー積み上げ',
    'dashboard.monthlyDeficit.totalLabel': '目安 - 食べた量 (合計)',
    ...
    'onboarding.basicInfo.unit': '単位系',
    'onboarding.basicInfo.metric': 'メートル法',
    'onboarding.basicInfo.imperial': 'ヤード・ポンド法',
    'onboarding.basicInfo.healthNote': 'Apple Healthとの連携は近日対応予定です。',
    'onboarding.basicInfo.height': '身長',
    'onboarding.basicInfo.cm': 'cm',
    'onboarding.basicInfo.ft': 'ft',
    'onboarding.basicInfo.in': 'in',
  ...
  'en-US': {
    ...
    'dashboard.monthlyDeficit.newTitle': 'Monthly accumulated deficit',
    'dashboard.monthlyDeficit.totalLabel': 'Maintenance - Intake (total)',
    ...
    'onboarding.basicInfo.unit': 'Measurement system',
    'onboarding.basicInfo.metric': 'Metric',
    'onboarding.basicInfo.imperial': 'Imperial',
    'onboarding.basicInfo.healthNote': 'Apple Health integration is coming soon.',
